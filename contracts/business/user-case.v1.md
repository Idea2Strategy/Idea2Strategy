---
schema_version: 1
id: contract.operations.user-case.v1
kind: business
status: approved
revision: 1
refs:
...
Status: approved canonical contract. Product authority `user:kcrmin` merged proposal PR [#150](https://github.com/Idea2Strategy/Idea2Strategy/pull/150).
...
## 8. Approval and canonical source

Proposal PR [#150](https://github.com/Idea2Strategy/Idea2Strategy/pull/150) records the approved decision source.
This contract and the A19 additive delta in `db/schema.dbml` are canonical.
