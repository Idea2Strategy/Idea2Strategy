...
Choice: Retire the old UI reference, freeze the approved Basic editor interactions and required states, and defer exact visual design to the UI implementation. An undecided visual baseline never blocks building or testing a screen.
