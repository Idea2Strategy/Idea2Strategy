...
'@
  ...
  Assert-True $ownerText.Contains('product_authorities: [user:kcrmin, user:pjy008008, user:Juwon-Na, user:Pearone99, user:hjcud]') 'authority reference names provider identities'
