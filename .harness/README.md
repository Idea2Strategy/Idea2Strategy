...
6. `.harness/` — discovery, workspace, governance, and command metadata only
...
- `governance.yaml`: protected product-authority configuration
- `ui/baselines/`: immutable UI design baselines, not moving branch pointers
- `work/provider.yaml`: Stackcord provider configuration
