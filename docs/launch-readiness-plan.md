...
5. v1.0.0 전까지 `specs/**`·`contracts/**`·`docs/product-authorities.yaml`·`docs/collaboration-policy.md`를 고칠 때는 제품 권한자(`kcrmin`·`pjy008008`·`Juwon-Na`·`hjcud`)의 지시를 PR 본문에 인용한다(`AGENTS.md` 참조). 그 외 경로는 이 규약과 무관하다.
