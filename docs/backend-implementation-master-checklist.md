...
- [ ] **INT08 — 보안·개인정보·법적 표현 검토**: 권한 우회, 비공개 전략 노출, 직접 주문, 투자 추천·위험 등급 표현과 데이터 권리를 검토한다.
